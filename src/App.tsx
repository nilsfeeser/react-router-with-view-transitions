...
import {TransitionProvider, PageTransition} from "./feature/page-transition.tsx";
...
const Page1 = () => {
    return (
        <div className="page page1">
            ...
            <PageTransition to="/page2" transition="push" className="button">
                weiter
            </PageTransition>
        </div>
    );
...
const Page2 = () => {
    const Navigation = () => (
        <div className="row">
            <PageTransition to="-1" transition="pop" className="button">
                zurück
            </PageTransition>

            <PageTransition to="/page3/0" transition="push" className="button">
                weiter
            </PageTransition>
        </div>
    );
